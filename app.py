...
app.layout = html.Div(children=[
    ...
    '''),
    dcc.Input(
        id='input-1-state', type='text', placeholder='Title of the question', value= 'Hi my name is Juan!',
   ...
   dcc.Textarea(
       ...
       value='I want to know if my mom loves me or not but I use python and C++ to ask my existential java question',
...
def update_output(n_clicks, input1, input2):
    if n_clicks > 0 and len(input1)>0 and len(input2)>0:
        ...
        return u'''Your cleaned tags are : \n{} \n Tags: {}\n'''.format(body,output)
    elif n_clicks == 0 :
